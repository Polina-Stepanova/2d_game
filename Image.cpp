...
Image::Image(const Image &source_img)
{
  if (source_img.self_allocated){
       data = new Pixel[source_img.Width() * source_img.Height() ]{};
       width=source_img.Width();
       height = source_img.Height();
       channels=source_img.Channels();
...
Image& Image::operator =(const Image &source_img)
{
     if (source_img.self_allocated){
       data = new Pixel[source_img.Width() * source_img.Height() ]{};
       width=source_img.Width();
